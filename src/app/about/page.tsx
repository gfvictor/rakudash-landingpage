      ...
      <main className="relative w-full flex-1">
        ...
        <section className="bg-card/30 border-border/40 relative overflow-hidden border-t py-24">
          <div className="relative z-10 container mx-auto max-w-6xl px-4 text-center md:px-8">
            ...
            <div className="mt-20 border-t border-border/40 pt-16 text-center flex flex-col items-center">
              <h3 className="mb-8 text-2xl font-bold tracking-tight sm:text-3xl">
                {t('about_page.cta.title')}
              </h3>
              <a
                href="/products/rakudash"
                className="bg-primary text-primary-foreground hover:bg-primary/90 flex items-center gap-2 rounded-xl px-8 py-4 font-bold shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
